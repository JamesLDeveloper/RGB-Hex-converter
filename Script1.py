...
def hex_rgb():
    ...
    if hex_val[0] != 0 and hex_val[0] !=1 and hex_val[0] != 2 and hex_val[0] != 3 and hex_val[0] != 4 \
    ...
    and hex_val[0].upper() != "E" and hex_val[0].upper() != "F" and \
    hex_val[1] != 0 and hex_val[1] !=1 and hex_val[1] != 2 and hex_val[1] != 3 and hex_val[1] != 4 \
    ...
    and hex_val[1].upper() != "E" and hex_val[1].upper() != "F" and \
    hex_val[2] != 0 and hex_val[2] !=1 and hex_val[2] != 2 and hex_val[2] != 3 and hex_val[2] != 4 \
    ...
    and hex_val[2].upper() != "E" and hex_val[2].upper() != "F" and \
    hex_val[3] != 0 and hex_val[3] !=1 and hex_val[3] != 2 and hex_val[3] != 3 and hex_val[3] != 4 \
    ...
    and hex_val[3].upper() != "E" and hex_val[3].upper() != "F" and \
    hex_val[4] != 0 and hex_val[4] !=1 and hex_val[4] != 2 and hex_val[4] != 3 and hex_val[4] != 4 \
    ...
    and hex_val[4].upper() != "E" and hex_val[4].upper() != "F" and \
